...
export const tools = [
  ...
  { name: 'Add Page Numbers', slug: 'add-page-numbers', category: 'pdf', icon: 'Hash', status: 'live', engine: 'browser', description: 'Add page numbers to a PDF document in seconds.' },
  { name: 'Add Watermark', slug: 'watermark-pdf', category: 'pdf', icon: 'Stamp', status: 'live', engine: 'browser', description: 'Add a text or image watermark to your PDF pages.' },
  { name: 'Protect PDF', slug: 'protect-pdf', category: 'pdf', icon: 'Lock', status: 'live', engine: 'browser', description: 'Add a password to encrypt and protect a PDF file.' },
  { name: 'Unlock PDF', slug: 'unlock-pdf', category: 'pdf', icon: 'Unlock', status: 'live', engine: 'browser', description: 'Remove a password from a PDF you have the rights to.' },
  { name: 'Sign PDF', slug: 'sign-pdf', category: 'pdf', icon: 'FileSignature', status: 'live', engine: 'browser', description: 'Draw or type a signature and place it on your PDF.' },

  // ---------- Image ----------
  { name: 'Compress Image', slug: 'compress-image', category: 'image', icon: 'Minimize2', status: 'live', engine: 'browser', description: 'Reduce JPG, PNG, and WebP image size without losing quality.' },
  { name: 'Resize Image', slug: 'resize-image', category: 'image', icon: 'Expand', status: 'live', engine: 'browser', description: 'Change image dimensions to any width and height online.' },
  { name: 'Crop Image', slug: 'crop-image', category: 'image', icon: 'Crop', status: 'live', engine: 'browser', description: 'Crop images to the exact frame or aspect ratio you need.' },
  { name: 'Convert Image', slug: 'convert-image', category: 'image', icon: 'RefreshCw', status: 'live', engine: 'browser', description: 'Convert between JPG, PNG, WebP, and GIF image formats.' },
  { name: 'Rotate Image', slug: 'rotate-image', category: 'image', icon: 'RotateCw', status: 'live', engine: 'browser', description: 'Rotate or flip images and save them instantly.' },
  { name: 'Image to Text (OCR)', slug: 'image-to-text', category: 'image', icon: 'ScanText', status: 'live', engine: 'browser', description: 'Extract text from an image with free online OCR.' },
  { name: 'Favicon Generator', slug: 'favicon-generator', category: 'image', icon: 'Image', status: 'live', engine: 'browser', description: 'Create a favicon for your website from any image.' },
  ...
  { name: 'Unit Converter', slug: 'unit-converter', category: 'convert', icon: 'RefreshCw', status: 'live', engine: 'browser', description: 'Convert length, weight, temperature, and other units.' },
