...
export const tools = [
  // ---------- PDF ----------
  { name: 'Merge PDF', slug: 'merge-pdf', category: 'pdf', icon: 'Files', status: 'soon', engine: 'browser', description: 'Combine multiple PDF files into one document online, free.' },
  { name: 'Split PDF', slug: 'split-pdf', category: 'pdf', icon: 'Scissors', status: 'soon', engine: 'browser', description: 'Split a PDF into separate pages or extract a page range.' },
  { name: 'Compress PDF', slug: 'compress-pdf', category: 'pdf', icon: 'Minimize2', status: 'soon', engine: 'browser', description: 'Reduce PDF file size online while keeping quality.' },
  { name: 'PDF to JPG', slug: 'pdf-to-jpg', category: 'pdf', icon: 'FileImage', status: 'soon', engine: 'browser', description: 'Convert each PDF page into a high-quality JPG image.' },
  { name: 'JPG to PDF', slug: 'jpg-to-pdf', category: 'pdf', icon: 'FileText', status: 'soon', engine: 'browser', description: 'Turn JPG and PNG images into a single PDF file.' },
  { name: 'Rotate PDF', slug: 'rotate-pdf', category: 'pdf', icon: 'RotateCw', status: 'soon', engine: 'browser', description: 'Rotate PDF pages and save them in the right orientation.' },
  { name: 'Organize PDF', slug: 'organize-pdf', category: 'pdf', icon: 'ListOrdered', status: 'soon', engine: 'browser', description: 'Reorder, rotate, and delete pages in a PDF document.' },
